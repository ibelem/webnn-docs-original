...
5. 从 ONNX 模型仓库下载 [`mobilenetv2-10_fp16.onnx`](https://hf-mirror.com/webnn/mobilenet-v2/resolve/main/onnx/mobilenetv2-10_fp16.onnx?download=true) 模型，并将其保存在项目的根文件夹中。非中国大陆用户可直接从 [HuggingFace](https://huggingface.co/webnn/mobilenet-v2/resolve/main/onnx/mobilenetv2-10_fp16.onnx?download=true) 下载。
