...
- Browser: [Microsoft Edge Canary](https://www.microsoft.com/en-us/edge/download/insider?form=MA13FJ)
- Hardware: GPU and NPU with up-to-date drivers supporting WebNN

### Enable WebNN API in Edge Canary

1. Download and install [Microsoft Edge Canary](https://www.microsoft.com/en-us/edge/download/insider?form=MA13FJ)
2. Launch Edge Canary, and navigate to about:flags in the address bar
...
2. Verify your setup by clicking the Go Live button in the bottom-right corner of VSCode, which launches a local server in Edge Canary.
...
5. Download the [`mobilenet2-10.onnx`](https://github.com/onnx/models/blob/main/validated/vision/classification/mobilenet/model/mobilenetv2-10.onnx) model from the ONNX Model Zoo and save it in your project's root folder.
