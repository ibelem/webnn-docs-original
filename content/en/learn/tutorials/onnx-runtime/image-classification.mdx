...
5. Download the [`mobilenetv2-10_fp16.onnx`](https://huggingface.co/webnn/mobilenet-v2/resolve/main/onnx/mobilenetv2-10_fp16.onnx?download=true) model from the ONNX Model Zoo and save it in your project's root folder. Users in the PRC can download the model [here](https://hf-mirror.com/webnn/mobilenet-v2/resolve/main/onnx/mobilenetv2-10_fp16.onnx?download=true).
