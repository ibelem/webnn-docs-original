...
> **Note:** You don't need to use `@webnn/types` if you're working with JavaScript ML libraries like [Transformers.js](https://huggingface.co/docs/transformers.js/index) or [ONNX Runtime Web](https://onnxruntime.ai/docs/api/js/index.html), which may include their own type definitions.
