...
export default function Hero() {
  ...
  return (
    <div className="xl:col-span-2 px-6 md:px-8 xl:pl-20 xl:pr-4 2xl:pl-20 pt-8 md:pt-24 lg:pt-24 pb-2 md:pb-16 lg:pb-20 items-center justify-items-base backdrop-blur-[1px]">
