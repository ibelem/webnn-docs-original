...
<div className="grid grid-cols-2 text-center gap-2 my-8">
  <div>
    <div>![No symbolic dimensions](/static/images/learn/tutorials/free-dimension-overrides-1.png)</div>
    <div className="mt-4">Example model without symbolic dimensions</div>
  </div>
  <div>
    <div>![Symbolic dimensions](/static/images/learn/tutorials/free-dimension-overrides-2.png)</div>
