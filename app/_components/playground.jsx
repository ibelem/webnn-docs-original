...
export function Playground({ isEditorPage }) {
  ...
  return (
    <div className="pg-com min-h-screen overflow-y-auto px-2 md:px-8 xl:px-8">
      ...
      <h3 id="webnn" className="text-2xl font-title light-color px-4 text-left"><WebNNIcon /> WebNN</h3>
      ...
      <h3 id="transformersjs" className="text-2xl font-title light-color px-4 text-left"><TransformersjsIcon /> Transformers.js</h3>
      <div className="container mx-auto m-4">
      ...
      <h3 id="onnx" className="text-2xl font-title light-color px-4 text-left"><OnnxIcon /> ONNX Runtime Web</h3>
      <div className="container mx-auto m-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5">
      ...
      <h3 id="litert" className="text-2xl font-title light-color px-4 text-left"><LiteRTIcon /> LiteRT</h3>
      <div className="container mx-auto m-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5">
