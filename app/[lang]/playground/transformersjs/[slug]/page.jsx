...
import { extractIdFromTransformersjsPath } from '../../utils.js';
import { Playground } from '../../../../_components/playground.jsx';

export default function Page() {
  const framework = 'transformersjs';
  ...
  const id = extractIdFromTransformersjsPath();

  let files;
  let title;

  try {
    if (transformersjsEditorFiles[id] && transformersjsEditorFiles[id][js]) {
      files = transformersjsEditorFiles[id][js];
      title = transformersjsEditorFiles[id].title;
        ...
        <div className="mx-1 md:mx-0 playground-nav">
          ...
          <div className="self-center">
            <div className={`pg-js ${js}`}>
              {transformersjsEditorFiles[id]?.static && (
                <button
              ...
              {transformersjsEditorFiles[id]?.vanilla && (
                <button
              ...
              {transformersjsEditorFiles[id]?.svelte && (
                <button
              ...
              {transformersjsEditorFiles[id]?.react && (
                <button
              ...
              {transformersjsEditorFiles[id]?.vue && (
                <button
